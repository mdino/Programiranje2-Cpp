...
int treci(){
    ...
    if(br==roba.br_roba){
     ...
     /*if(roba.br_roba!=br){
                       cout<<"DUPLIKAT!!!\n\n";
                       return 0;
                       }//if*/ //prepisuje se tek nakon 4 zadatka
...
int main(){
    ...
    do{
        ...
        cout<<"3. PretraA3ivanje relativne datoteke"<<endl;
        cout<<"4. Unos podataka o robi u relativnu datoteku (vodi raÄ?una o duplikatima)"<<endl;
